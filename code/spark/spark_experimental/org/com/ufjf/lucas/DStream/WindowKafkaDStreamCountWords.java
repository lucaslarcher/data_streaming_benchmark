...
public class WindowKafkaDStreamCountWords {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Collection<String> topics = Arrays.asList("stream-topic");
        ...
        JavaPairDStream<String,Long> countDStream = pairDStream.reduceByKeyAndWindow((value1,value2) -> value1+value2, Durations.seconds(10));
